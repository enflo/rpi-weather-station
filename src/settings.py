...
SENSOR_COMMUNITY_SENSOR_SDS011_ID = os.getenv("SENSOR_COMMUNITY_SENSOR_SDS011_ID", "123456")
SENSOR_COMMUNITY_SENSOR_BME280_ID = os.getenv("SENSOR_COMMUNITY_SENSOR_BME280_ID", "123456")

# INFLUXDB CONFIG
INFLUXDB_ENABLE = get_bool_env("INFLUXDB_ENABLE", False)
INFLUXDB_URL = os.getenv("INFLUXDB_URL", "http://localhost:8086")
INFLUXDB_TOKEN = os.getenv("INFLUXDB_TOKEN", "my-token")
INFLUXDB_ORG = os.getenv("INFLUXDB_ORG", "my-org")
INFLUXDB_BUCKET = os.getenv("INFLUXDB_BUCKET", "weather")
INFLUXDB_TIMEOUT = int(os.getenv("INFLUXDB_TIMEOUT", 10000))
INFLUXDB_VERIFY_SSL = get_bool_env("INFLUXDB_VERIFY_SSL", True)
